...
# Botón para abrir la consola de operación de reportes
tk.Button(
    root, text="Abrir Consola de Operación de Reportes", font=("Arial", 12, "bold"),
    bg="#4a90e2", fg="white", command=abrir_consola_operacion).pack(pady=10)

# Botón para abrir la consola de administrador
tk.Button(
    root, text="Abrir Consola de Administrador", font=("Arial", 12, "bold"),
    bg="#4a90e2", fg="white", command=abrir_consola_administrador).pack(pady=10)
